...
class TwitterClient(object):
   ...
   def __init__(self):
       ...
       consumer_key = "CIJouGkAuiy5mEgrCmutg9Fn0"
       consumer_secret = "k4qHIAcXC6iZR7gOdQqJdgVRnJMD5Bbg4NNRh02HqL69aiQHLr"
       access_token = "2496109776-4h9xDHggQIiAlzoOvlhRXlnr3LlATeBsC0aJcdA"
       access_token_secret ="CEvOG38MU83fNQzwfa3SWOXvREiMs2F0HeUfvh3aOCGkb"
...
def sentimentCalculator(keyword, count):
  ...
  #list containing neutral tweets
